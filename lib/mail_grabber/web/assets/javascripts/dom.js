var MailGrabberDOM = {
   ...
   * click on a tab e.g. Plain Text, then this content will be active and the
   * others hidden.
   *
   * @param {Object} event - which part did we click
   */
   ...
   *
   * @param {String} selector - which describes how to find the element
   *
  ...
  /**
   * Show the default background image instead of any content.
   */
   ...
   * set the default background, and the infinite scroll params when we click on
  ...
  /**
   * Root path, which returns the server's root path. It can be an empty
