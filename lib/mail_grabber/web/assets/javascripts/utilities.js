var MailGrabberUtilities = {
   ...
   *
   * @param {DateTime} dateTime - the message created at the attribute
   * @param {String} ouputType - what type would we like to see
   *
   ...
   *
   * @return {String} the formatted number with a unit
   */
